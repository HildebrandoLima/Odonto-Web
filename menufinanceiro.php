    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <h6 class="dropdown-header"> Controle Financeiro: </h6>
			<a class="dropdown-item" href="financeiro.php"> Analisar Custos </a>
			<a class="dropdown-item" href="registrar-custo.php"> Registrar Custos </a>
			<a class="dropdown-item" href="contas-receber.php"> Contas a Receber </a>
			<a class="dropdown-item" href="demonstracao-lucro.php"> Demons. de Lucro </a>
          </div>
        </li>
		<li class="nav-item active">
